      ...
      <header className="sticky top-0 z-30 w-full backdrop-blur-md bg-amber-50/85 border-b border-amber-200/60 transition-all duration-300">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Botón Donar con Cripto */}
            <button
              type="button"
              onClick={() => setIsDonateOpen(true)}
              className="inline-flex items-center gap-1 px-2.5 sm:px-3 py-1.5 rounded-full text-xs font-semibold bg-amber-200/80 hover:bg-amber-300 text-amber-950 border border-amber-300 transition-all shadow-sm active:scale-95 cursor-pointer"
              title="Apoyar al creador con Criptomonedas"
            >
            ...
            >
              ...
              <span className="hidden xs:inline">Dedicar Flores</span>
              <span className="xs:hidden">Dedicar</span>
            </Link>
          </div>
        </div>
